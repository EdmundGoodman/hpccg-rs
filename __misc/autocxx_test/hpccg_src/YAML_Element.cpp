 ...
 * @return A pointer to the YAML element if the key is in the vector, otherwise 0.
 */
 ...
 *
 * Correct YAML depends on correct spacing; the parameter space should be the proper
 * amount of space for the parent element
 *
 * @param space A string containing the correct amount of spacing for the YAML schema.
